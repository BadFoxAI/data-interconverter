...
export class AppState {
  ...
  setIndexFromTextSimple(text: string): void;
  executeJsonInstructionsToCI(json_string: string): bigint;
  generateJsonInstructionsForCurrentCI(_strategy: string): string;
}
...
export interface InitOutput {
  ...
  readonly appstate_generateJsonInstructionsForCurrentCI: (a: number, b: number, c: number) => [number, number, number, number];
