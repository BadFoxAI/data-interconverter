...
export class AppState {
  ...
  setSequenceData(js_sequence_array_of_bigints: any, bit_depth: number): void;
...
export interface InitOutput {
  ...
  readonly appstate_setTextData: (a: number, b: number, c: number) => [number, number];
  readonly appstate_getTextRepresentation: (a: number) => [number, number, number, number];
  readonly appstate_setSequenceData: (a: number, b: any, c: number) => [number, number];
